...
loadmodel.load_model('./models/CandleUpDown.cbm')

df = stock_data_1mo("^N225")
imageUp = Image.open("./images/yousen.png")
imageDown = Image.open("./images/insen.png")

###################################################
st.title("明日のローソク足を予測")

st.text("CatBoostで日経225株価の明日のローソク足予測")
image = Image.open("./images/catboost2.png")
st.image(image)
...
if btnPush:
    ...
    st.subheader("明日の日経225平均ローソク足予想")
